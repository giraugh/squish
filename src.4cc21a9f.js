...
},{"./entity":11,"./util":10}],12:[function(require,module,exports) {
// TinyColor v1.4.1
...
},{"./entity":11,"tinycolor2":12}],13:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var ParticleEntity = function (_PhysicsEntity) {
  ...
  _createClass(ParticleEntity, [{
    ...
    value: function draw(ctx) {
      ...
      ctx.beginPath();
      // ctx.arc(this.x, this.y, this.radius, 0, Math.PI * 2)
      var squishAmount = Math.pow(this.vx, 2) + Math.pow(this.vy, 2);
      var theta = Math.atan2(this.vy, this.vx) + Math.PI / 2;
...
},{"./physicsEntity":6,"./splatterEntity":17}],14:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
},{"./entity.js":11}],15:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
},{"./entity":11,"tinycolor2":12,"./util":10}],16:[function(require,module,exports) {
var _require = require('./util'),
...
var PlayerEntity = function (_PhysicsEntity) {
  ...
  _createClass(PlayerEntity, [{
    key: 'die',
    value: function die(addEntity, delayRespawn) {
      // Remove Player
      this.remove = true;
      ...
      for (var i = 0; i < particleNum; i++) {
        ...
        var particle = new ParticleEntity(x, y, 9, { colour: this.getColour() });
        addEntity(particle);
      }
...
},{"./physicsEntity":6,"./particleEntity":13,"./scoreParticleEntity":14,"./corpseEntity":15,"./botBrain":16,"tinycolor2":12,"./util":10,"./input":5}],8:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var BirthEntity = function (_Entity) {
  ...
  function BirthEntity() {
    ...
    _this.time = 0;
    _this.fadeTime = 80;
    _this.dontProgressTime = opts.dontProgressTime || false;
...
},{"./entity":11,"./playerEntity":7,"tinycolor2":12,"./util":10}],9:[function(require,module,exports) {
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }

var initTogglingPlayers = function initTogglingPlayers() {
  // Gets players (that are in order)
  var players = document.querySelectorAll('.player');
  players.forEach(function (el, i) {
    return el.addEventListener('click', function () {
      var cl = [].concat(_toConsumableArray(el.classList));
      var enabled = cl.includes('enabled');

      // Change button state
      if (enabled) {
        el.classList = [].concat(_toConsumableArray(cl.filter(function (c) {
          return c !== 'enabled';
        })), ['disabled']).join(' ');
      } else {
        el.classList = [].concat(_toConsumableArray(cl.filter(function (c) {
      ...
      console.log(window.entities.filter(function (e) {
        return e.spawn != null && e.fadeTime != null;
      }));

      // Kill or disable spawning
      if (enabled) {
        // Find player
        var _players = window.entities.filter(function (e) {
        ...
        if (player) {
          ...
          var spawners = window.entities.filter(function (e) {
            return e.spawn != null && e.fadeTime != null;
          });
          var spawner = spawners.find(function (s) {
            return s.spawn.number === i;
          });
          if (spawner) {
        ...
        var _spawners = window.entities.filter(function (e) {
          return e.spawn != null && e.fadeTime != null;
        });
        var _spawner = _spawners.find(function (s) {
          return s.spawn.number === i;
        });
        if (_spawner) {
          _spawner.dontProgressTime = false;
          _spawner.time = 0;
        } else {
          console.warn('Couldnt find spawner w/ number ' + i);
        }
...
var initTogglingPlayers = require('./togglingPlayers');
...
var spawnPlayer = function spawnPlayer(n, opts, delayRespawn) {
  var players = entities.filter(function (e) {
  ...
  entities.push(new (Function.prototype.bind.apply(BirthEntity, [null].concat(_toConsumableArray(spawn), [50, 50, { number: n, colour: player.getColour(), spawn: player, label: 'birth', dontProgressTime: delayRespawn }])))());
};
...
module.exports = main;
},{"./physicsEntity":6,"./playerEntity":7,"./birthEntity":8,"./togglingPlayers":9,"./input":5,"./util":10}],4:[function(require,module,exports) {
...
loop();
},{"./main":3,"./canvas":4,"./input":5}],21:[function(require,module,exports) {
...
//# sourceMappingURL=/src.4cc21a9f.map