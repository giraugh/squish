...
},{"./entity":20,"./util":15}],30:[function(require,module,exports) {
// TinyColor v1.4.1
...
},{"./entity":20,"tinycolor2":30}],21:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
},{"./physicsEntity":12,"./splatterEntity":32}],22:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
},{"./entity.js":20}],23:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
},{"./entity":20,"tinycolor2":30,"./util":15}],24:[function(require,module,exports) {
var _require = require('./util'),
...
var isDown = function isDown(inputs, input) {
  var i = inputs[input];
  if (i.type === 'keyboard') {
...
var isPressed = function isPressed(inputs, input) {
  var i = inputs[input];
  if (i.type === 'keyboard') {
...
},{"./physicsEntity":12,"./particleEntity":21,"./scoreParticleEntity":22,"./corpseEntity":23,"./botBrain":24,"tinycolor2":30,"./util":15}],14:[function(require,module,exports) {
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
},{"./entity":20,"./playerEntity":13,"tinycolor2":30,"./util":15}],6:[function(require,module,exports) {
...
var spawnPlayer = function spawnPlayer(n, opts) {
  ...
  var player = new (Function.prototype.bind.apply(PlayerEntity, [null].concat(_toConsumableArray(spawn), [50, 50, Object.assign(Object.assign({}, playerOpts), opts)])))();
...
module.exports = main;
},{"./physicsEntity":12,"./playerEntity":13,"./birthEntity":14,"./util":15}],7:[function(require,module,exports) {
...
loop();
},{"./main":6,"./canvas":7,"./input":8}],33:[function(require,module,exports) {
